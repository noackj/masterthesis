...
\def\checkListTabHead{\begin{table}[!ht] \centering \begin{tabular}{|p{0.05\textwidth}|p{0.82\textwidth}|p{0.07\textwidth}|} \hline\scriptsize Nr. &\scriptsize Anforderung &\scriptsize Erfüllt\\ \hline\hline}
\def\plainTabularTextWOCheckbox#1{& \begin{tabular}{p{14,1cm}} \scriptsize#1 \\\end{tabular} & \\}%{ #1 & \\}
\def\plainTabularTextChecked#1{\stepcounter{ChecklistNumber}\begin{tabular}{p{1cm}}\scriptsize \theChecklistNumber \\\end{tabular} & \begin{tabular}{p{14,1cm}} \scriptsize#1 \\\end{tabular} & \checked \\}
...
\def\tabularitemizeFirstLayerCheck#1{\stepcounter{ChecklistNumber}\begin{tabular}{p{1cm}}\scriptsize \theChecklistNumber \\\end{tabular} & \begin{tabular}{p{0,3cm}p{13,4cm}}\scriptsize\textbullet & \scriptsize#1 \\\end{tabular} & \checked\\}
\def\tabularitemizeFirstLayerUncheck#1{\stepcounter{ChecklistNumber}\begin{tabular}{p{1cm}}\scriptsize \theChecklistNumber \\\end{tabular} & \begin{tabular}{p{0,3cm}p{13,4cm}}\scriptsize\textbullet & \scriptsize#1 \\\end{tabular} & \unchecked\\}
\def\tabularitemizeSecondLayerCheck#1{\stepcounter{ChecklistNumber}\begin{tabular}{p{1cm}}\scriptsize \theChecklistNumber \\\end{tabular} & \begin{tabular}{p{0,3cm}p{0,3cm}p{12,7cm}}&\scriptsize - & \scriptsize#1 \\\end{tabular} & \checked\\}
\def\tabularitemizeSecondLayerUncheck#1{\stepcounter{ChecklistNumber}\begin{tabular}{p{1cm}}\scriptsize \theChecklistNumber \\\end{tabular} & \begin{tabular}{p{0,3cm}p{0,3cm}p{12,7cm}}&\scriptsize - & \scriptsize#1 \\\end{tabular} & \unchecked\\}
