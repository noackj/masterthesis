...
\begin{acronym}[XXXXX] %Option in eckigen Klammern ist längste Abkürzung
 ...
 \acro{QMB}{Qualitätsmanagementbeauftragter}
 \acro{QMS}{Qualitätsmanagementsystem}
 \acro{RA}{Regulatory Affairs}
...
\begin{itemize}
\item Kundenrückmeldung bearbeiten
\item Fehlerkategorie bestimmen
\item Meldesystem
\item Rückrufaktion/Korrekturmaßnahme im Feld
\item Änderungsvorgang
\item Statistische Auswertung zu Kundenrückmeldungen durchführen
...
\item Fehlerursachenanalyse durchführen (Root Cause)
\end{itemize}
...
Ad-Hoc Sub-Process \citep[vgl.][S. 180]{OMG2011}\citep[vgl.][S. 431]{OMG2011}
%===================================================================== Cahpter 4
