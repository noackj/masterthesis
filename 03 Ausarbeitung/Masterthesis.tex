...
\hline
% =============================== row 2
\vspace{0mm} % makes space to hline the same for all rows
Plan zur Überwachung nach dem Inverkehrbringen: & \\
\begin{tabular}{p{0,3cm}p{13,6cm}}
\textbullet & Für die Überwachung nach dem Inverkehrbringen muss ein Plan erstellt werden, der Teil der technischen Doku ist \\
\end{tabular}
&
\unchecked\\
\begin{tabular}{p{0,3cm}p{13,6cm}}
\textbullet & Enthält u.A. Vorgehen, wie Trends erkannt werden (Methodik), zu behandeln sind und wie der Beobachtungszeitraum festgelegt wird \\
\end{tabular}
&
\unchecked\\
\hline
...
\begin{tabular}{p{0,3cm}p{13,6cm}}
\textbullet & Aktualisierung des Risikomanagements \\
\end{tabular}
&
\unchecked\\
\begin{tabular}{p{0,3cm}p{13,6cm}}
\textbullet & Aktualisierung der GA, Informationen zur Herstellung und Kennzeichnung \\
\end{tabular}
&
\unchecked\\
\begin{tabular}{p{0,3cm}p{13,6cm}}
\textbullet & Aktualisierung der klinischen Bewertung \\
\end{tabular}
&
\unchecked\\
\begin{tabular}{p{0,3cm}p{13,6cm}}
\textbullet & Aktualisierung Kurzbericht über Sicherheit und klinische Leistung (für Klasse III Geräte) \\
\end{tabular}
&
\unchecked\\
\begin{tabular}{p{0,3cm}p{13,6cm}}
\textbullet & Ermittlung des Bedarfs an Präventiv-, Korrektur- oder Sicherheitskorrekturmaßnahmen im Feld \\
\end{tabular}
&
\unchecked\\
\begin{tabular}{p{0,3cm}p{13,6cm}}
\textbullet & Ermittlung von Möglichkeiten zur Verbesserung der Gebrauchstauglichkeit, der Leistung und der Sicherheit des Produkts \\
\end{tabular}
&
\unchecked\\
\begin{tabular}{p{0,3cm}p{13,6cm}}
\textbullet & Beitrag zur Überwachung anderer Produkte nach dem Inverkehrbringen \\
\end{tabular}
&
\unchecked\\
\begin{tabular}{p{0,3cm}p{13,6cm}}
\textbullet & Erkennung und Meldung von Trends \\
\end{tabular}
&
\unchecked\\
\hline
