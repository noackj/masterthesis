...
Aus dieser Definition geht klar hervor, dass die oberste Pflicht des Herstellers die Sicherstellung der Sicherheit für die Anwender und Patienten ist. Relativiert wird diese Aussage lediglich durch den Zusatz, dass Risiken immer im Verhältnis zum erwarteten Patientennutzen stehen müssen. Ein hohes Risiko für den Patienten ist somit nur akzeptabel, wenn die durchgeführten Aktionen zu einer bedeutenden Verbesserung des Gesundheitszustandes des Patienten führt. Diese Abwägung findet in einem entsprechenden Evaluierungsprozess vor der Markteinführung statt (vgl. \cite[S. 11]{Ramakrishna2015}). 
...
Während der gesamten Einführungsphase von Polarion wurde die Strategie verfolgt möglichst wenig Restriktionen zu verwenden, um die Akzeptanz bei der Einführung nicht durch zu strikte und in den Augen der Nutzer vielleicht unnötige Regeln zu gefährden. Aus diesem Grund macht es auch für die neuen Anpassungen keinen Sinn, in der frühen Phase feste Workflows zu definieren.
