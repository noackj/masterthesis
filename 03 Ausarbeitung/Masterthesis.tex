...
\def\plainTabularText#1#2{\vspace{0mm} #1 & \vspace{0mm} #2\\}
\def\tabularitemizeFirstLayer#1#2{\begin{tabular}{p{0,3cm}p{13,4cm}}\textbullet & #1 \\\end{tabular} & #2\\}
\def\tabularitemizeSecondLayer#1#2{\begin{tabular}{p{0,3cm}p{0,3cm}p{12,7cm}}& - & #1 \\\end{tabular} & #2\\}
