...
\def\requestListTabHead{\begin{table}[ht] \centering \begin{tabular}{|p{0.05\textwidth}|p{0.81\textwidth}|p{0.08\textwidth}|} \hline\scriptsize Nr. & Anforderung & \scriptsize Art.\\ \hline\hline}
...
\tabularitemizeFirstLayerWOCount{Aktualisierungsintervalle:}{}
...
- größtes Problem dabei war die rückwärts gerichtete Traceability (von den Requirement Items) zu den eventuell möglichen Kundenrückmeldungen bzw. gemeledeten Vorkommnissen
...
- Ansonsten droht der Verlust der Kontrolle über die Prozesse, oder dass die Prozesse immer uneffizienter werden, was gerade in der momentanen Wachstumsphase, in der sich WOM aktuell befindet, äußerst negative Impulse verbreiten könnte und zu einem echten Problem für die Wettbewerbsfähigkeit führen kann
