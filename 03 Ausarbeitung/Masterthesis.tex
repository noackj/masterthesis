...
Die erstellten Prozessmodelle werden zudem im sekundären Ziel dazu verwendet, die Schnittstelle zwischen den Post-Market-Surveillance-Prozessen und dem F\&E-Bereich zu verbessern, da dessen Leistungsfähigkeit aktuell nicht den gestellten Anforderungen von WOM genügen.
...
Wie bereits in Kapitel \ref{sec:RegRequ} angesprochen, besitzt die Sicherheit medizinischer Geräte eine besondere Bedeutung. Auch hierfür liefert die \ac{GHTF} eine Definition für eine essentielle Perspektive auf das Thema Sicherheit \cite[S. 6]{GHTF2012b}.
...
Zu den möglichen Datenquellen gehören laut (vgl. \cite[S. 285-288]{Abuhav2012}):
\begin{itemize}
\item Distributoren
...
Nachdem in der Planungsphase grundlegende Festlegungen getroffen wurden, kann die Analyse der derzeitigen Prozesse begonnen werden. Ein mögliches Vorgehen bei der Modellierung von Geschäftsprozessen wird in (vgl. \cite[S. 13-17]{Jacka2009}) beschrieben und besteht aus den folgenden Schritten:
\begin{enumerate}
...
\hline
\SimpleTableEntry{Normative Anforderung zum zyklischen Aktualisierung der klinischen Evaluation}{Aktualisierung der klinischen Bewertung}
\hline
