...
\def\checkListTabHead{\begin{table}[ht] \centering \begin{tabular}{|p{0.87\textwidth}|p{0.07\textwidth}|} \hline Anforderung & Erfüllt\\ \hline\hline}
\def\checkListTabBottom{\end{tabular}\end{table}}
\def\plainTabularTextWOCheckbox#1{\vspace{0mm} #1 & \\}
\def\plainTabularTextChecked#1{#1 & \checked\\}
\def\plainTabularTextUnchecked#1{#1 & \unchecked\\}
\def\tabularitemizeFirstLayerCheck#1{\begin{tabular}{p{0,3cm}p{13,4cm}}\textbullet & #1 \\\end{tabular} & \checked\\}
\def\tabularitemizeFirstLayerUncheck#1{\begin{tabular}{p{0,3cm}p{13,4cm}}\textbullet & #1 \\\end{tabular} & \unchecked\\}


\section{Liste der ermittelten Anforderungen}

\checkListTabHead
% =============================== row 1
\plainTabularTextUnchecked{System zur Überwachung nach dem Inverkehrbringen (als integraler Bestandteil des QMS) muss eingerichtet sein, angewendet, instandgehalten und dauernd aktualisiert werden}
\hline
% =============================== row 2
\plainTabularTextWOCheckbox{Plan zur Überwachung nach dem Inverkehrbringen:}
\tabularitemizeFirstLayerUncheck{Für die Überwachung nach dem Inverkehrbringen muss ein Plan erstellt werden, der Teil der technischen Doku ist}
...
\tabularitemizeFirstLayerUncheck{Aktualisierung des Risikomanagements}
\tabularitemizeFirstLayerUncheck{Aktualisierung der GA, Informationen zur Herstellung und Kennzeichnung}
\tabularitemizeFirstLayerUncheck{Aktualisierung der klinischen Bewertung}
\tabularitemizeFirstLayerUncheck{Aktualisierung Kurzbericht über Sicherheit und klinische Leistung (für Klasse III Geräte)}
\tabularitemizeFirstLayerUncheck{Ermittlung des Bedarfs an Präventiv-, Korrektur- oder Sicherheitskorrekturmaßnahmen im Feld}
\tabularitemizeFirstLayerUncheck{Ermittlung von Möglichkeiten zur Verbesserung der Gebrauchstauglichkeit, der Leistung und der Sicherheit des Produkts}
\tabularitemizeFirstLayerUncheck{Beitrag zur Überwachung anderer Produkte nach dem Inverkehrbringen}
\tabularitemizeFirstLayerUncheck{Erkennung und Meldung von Trends}
\plainTabularTextUnchecked{Die Technische Dokumentation ist immer aktuell zu halten}
\hline
\checkListTabBottom
...
\begin{table}[ht]
\begin{center}
\begin{tabular}{|p{0.88\textwidth}|p{0.07\textwidth}|}
\hline
Anforderung & Erfüllt\\
\hline\hline
System zur Überwachung nach dem Inverkehrbringen (als integraler Bestandteil des QMS) muss eingerichtet sein, angewendet, instandgehalten und dauernd aktualisiert werden
&
\checked\\
\hline
Plan zur Überwachung nach dem Inverkehrbringen:
\begin{itemize}
\item Für die Überwachung nach dem Inverkehrbringen muss ein Plan erstellt werden, der Teil der technischen Doku ist
\item Enthält u.A. Vorgehen, wie Trends erkannt werden (Methodik), zu behandeln sind und wie der Beobachtungszeitraum festgelegt wird
\end{itemize}
&
\unchecked\\
\hline
Es werden Daten über Qualität, Leistung und Sicherheit eines Produktes während gesamter Lebensdauer gesammelt, aufgezeichnet, analysiert und verwendet für:
\begin{itemize}
\item Aktualisierung des Risikomanagements
\item Aktualisierung der GA, Informationen zur Herstellung und Kennzeichnung
\item Aktualisierung der klinischen Bewertung
\item Aktualisierung Kurzbericht über Sicherheit und klinische Leistung (für Klasse III Geräte)
\item Ermittlung des Bedarfs an Präventiv-, Korrektur- oder Sicherheitskorrekturmaßnahmen im Feld
\item Ermittlung von Möglichkeiten zur Verbesserung der Gebrauchstauglichkeit, der Leistung und der Sicherheit des Produkts
\item Beitrag zur Überwachung anderer Produkte nach dem Inverkehrbringen
\item Erkennung und Meldung von Trends
\end{itemize}
Die Technische Dokumentation ist immer aktuell zu halten
&
\unchecked\\
\hline
\end{tabular}
...
Anforderung & Erfüllt\\
\hline\hline
Durchführung und Überwachung von Präventiv- und Korrekturmaßnahmen aufgrund von gesammelten Daten inklusive Unterrichtung der zuständigen Behörden und ggf. benannter Stelle durch den Hersteller
&
\unchecked\\
\hline
Schwerwiegende Vorkommnisse oder Sicherheitskorrekturmaßnahmen im Feld:
\begin{itemize}
\item Schwerwiegende Vorkommnisse, die im Zusammenhang zum Produkt sind, werden den Behörden über elektronisches System gemeldet, außer es sind erwartete Nebenwirkungen laut Produktinformation, in techn. Doku quantifiziert und durch Meldung von Trends erfasst
\begin{itemize}
\item Meldung innerhalb 2 Tage nach Kenntnis der Gefahr, wenn schwerwiegende Gefahr für öffentliche Gesundheit besteht
\item Meldung innerhalb 10 Tage nach Kenntnis des Vorkommnisses, wenn Tod oder unvorhergesehener Verschlechterung des Gesunheitszustandes einer Person und Kausalzusammenhang zum Produkt besteht oder vermutet wird
\item Meldung innerhalb 15 Tage nach Kenntnis des Vorkommnisses, wenn Kausalzusammenhang zwischen Produkt und Vorkommniss festgestellt wurde oder möglich ist
\end{itemize}
\item Sicherheitskorrekturmaßnahmen im Feld, auch wenn außerhalb EU, aber Grund für Maßnahme direkt vom Produkt ausgeht, werden den zuständigen Behörden über elektronisches System gemeldet
\begin{itemize}
\item Meldung über Sicherheitskorrekturmaßnahme im Feld in nicht dringenden Fällen ohne gebührliche Verzögerung vor der Durchführung
\item Bei wiederholenden Meldungen (ähnliches Vorkommniss mit gleichem Produkt oder Produktart,  schon erfolgter Sicherheitskorrekturmaßnahme oder häufig auftretend aber gut dokumentiert) kann periodische Sammelmeldung über elektronisches System erfolgen
\end{itemize}
\item Untersuchung  (u.A. Risikobewertung) folgt unverzüglich auf Meldung eines schwerwiegenden Vorkommnisses durch den Hersteller
\begin{itemize}
\item Zusammenarbeit ggf. mit Behörden und benannter Stelle
\item Untersuchung muss sicherstellen, dass spätere Bewertung der Ursache des Vorkommnisses noch möglich ist oder Maßnahmen, die dagegen verstoßen würden, müssen vorher mit Behörde abgesprochen werden
\end{itemize}
\item Notwendige Unterlagen müssen bei entsprechenden Anfragen an die Behörden ausgehändigt werden
\item Erstellung eines Abschlussberichtes (enthält Schlussfolgerungen und ggf. zu ergreifende Korrekturmaßnahmen) und Einreichung über elektronisches System
\item Bei ergriffenen Sicherheitskorrekturmaßnahmen im Feld müssen die Anwender mittels Sicherheitsanweisung im Feld über elektronisches System informiert werden
\begin{itemize}
\item Entwurf der Anweisung wird koordinierender zuständiger Behörde vorgelegt (außer in dringenden Fällen), damit diese Anmerkungen abgeben kann
\item Identifikation über UDI und SRN
\item Enthalten sind Gründe für Sicherheitskorrekturmaßnahme im Feld mit Verweis auf Fehlfunktion und Risiken für Patienten, Anwender oder Dritte sowie alle zu ergreifenden Maßnahmen
\end{itemize}
\item Information über mögliche schwerwiegende Vorkommnisse können von zuständiger Behörde kommen, sofern diese zuerst informiert wurde
\begin{itemize}
\item Behörde kann vom Hersteller Schritte gemäß schwerwiegendem Vorkommniss einfordern, auch wenn dieser ermittelt hat, dass Vorfall nicht schwerwiegend ist oder es als erwartete, unerwünschte Nebenwirkung, die in der Meldung von Trends enthalten sein wird, klassifiziert
\end{itemize}
\end{itemize}
&
\unchecked\\
