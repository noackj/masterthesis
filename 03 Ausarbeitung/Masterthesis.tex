...
\def\requestListTabHead{\begin{table}[ht] \centering \begin{tabular}{|p{0.84\textwidth}|p{0.1\textwidth}|} \hline\scriptsize Anforderung & \scriptsize Art.\\ \hline\hline}
...
\def\plainTabularText#1#2{\begin{tabular}{p{13,6cm}}\scriptsize#1 \\\end{tabular} & \begin{tabular}{p{1cm}}\scriptsize#2 \\\end{tabular}\\}
\def\tabularitemizeFirstLayer#1#2{\begin{tabular}{p{0,3cm}p{12,9cm}}\scriptsize\textbullet & \scriptsize#1 \\\end{tabular} & \begin{tabular}{p{1cm}}\scriptsize#2 \\\end{tabular}\\}
\def\tabularitemizeSecondLayer#1#2{\begin{tabular}{p{0,3cm}p{0,3cm}p{12,1cm}}&\scriptsize - & \scriptsize#1 \\\end{tabular} & \begin{tabular}{p{1cm}}\scriptsize#2 \\\end{tabular}\\}
\def\tabularitemizeSecondLayerUncheck#1{\begin{tabular}{p{0,3cm}p{0,3cm}p{12,7cm}}\scriptsize&\scriptsize - & \scriptsize#1 \\\end{tabular} & \unchecked\\}
