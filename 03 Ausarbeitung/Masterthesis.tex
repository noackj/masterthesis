...
\begin{titlepage}
%\centering
\noindent{\bfseries\Huge Sperrvermerk}\\[2cm]
Die vorliegende Masterarbeit mit dem Titel:

{\noindent\bfseries Modellierung der Qualitätsmanagementprozesse für die Marktüberwachung und Vigilanz in der Entwicklung von Medizinprodukten unter Berücksichtigung der MDR EU 2017/745}
\newline
\newline
\newline
\newline
...
{\noindent\bfseries W.O.M. WORLD OF MEDICINE GmbH, Salzufer 8, 10587 Berlin}
\newline
\newline
\newline
\newline
{\bfseries Eine Einsicht in diese Masterarbeit ist nicht gestattet. Ausgenommen davon sind die betreuenden Dozenten sowie die befugten Mitglieder des Prüfungsausschusses. Eine Einsichtnahme, Veröffentlichung und Vervielfältigung der Masterarbeit – auch in Auszügen – ist nicht gestattet.}
\newline
\newline
\newline
...
Normative Anforderungen stellen im Medizintechnikmarkt eine besondere Herausforderung für die dort tätigen Unternehmen dar. Durch sie werden grundlegende Anforderungen an die Hersteller gesetzlich vorgeschrieben, was Auswirkungen bis tief in die Unternehmensprozesse hinein nach sich zieht. Mit der in 2017 eingeführten Medical Device Regulation (MDR), die die aktuelle EU Verordnung für die Regulierung des Medizinproduktemarkts darstellt, wurde dieser Anforderungskatalog unlängst aktualisiert, was eine Vielzahl neuer Herausforderungen für die Hersteller beinhaltet. 

Diese Ausarbeitung beschäftigt sich primär mit den damit verbundenen Auswirkungen für das Unternehmen WOM in dem Teilgebiet der nach Markteinführung zu erfüllenden Unternehmensprozesse (Post Market Surveillance). Zu diesem Zweck wird ein Prozessmodell der aktuell in diesem Kontext implementierten Unternehmensprozesse mit der Modellierungssprache BPMN 2.0 erstellt. Zur Erfassung der Anforderungen wird eine Checkliste aus der MDR erstellt, anhand derer durch Vergleich der Anforderungen mit den erstellten Prozessmodellen der aktuelle Erfüllungsgrad bewertet wird. Auf der Grundlage der dadurch ermittelten nicht umgesetzten Anforderungen wird ein Vorschlag für ein Prozessmodell erarbeitet, durch das nur minimal notwendige Änderungen an den aktuellen Prozessen vorgenommen werden müssen.

Die erstellten Prozessmodelle werden zudem im sekundären Ziel dazu verwendet, die Schnittstelle zwischen den Post-Market-Surveillance-Prozessen und dem F\&E-Bereich zu verbessern, da deren Leistungsfähigkeit aktuell nicht den gestellten Anforderungen von WOM genügt.
...
\begin{acronym}[XXXXX] %Option in eckigen Klammern ist längste Abkürzung
 ...
 \acro{GHTF}{Global Harmonization Task Force}
...
Mit der in 2017 eingeführten \ac{MDR}, die die aktuelle EU-Verordnung für die Regulierung des Medizinproduktemarkt darstellt, kam es erneut zu einem so einschneidendem Ereignis, wodurch nahezu alle am Markt beteiligten Unternehmen vor neue Herausforderungen gestellt wurden. Momentan befindet sich die MDR im Einführungsstadium mit der Gewährung von Übergangsfristen für die Hersteller und die verantwortlichen Behörden, was bedeutet, dass die neuen Regularien überwiegend noch nicht den Weg in die Praxis gefunden haben, sich aber alle betroffenen Parteien auf die entsprechenden Stichtage zur verbindlichen Einführung vorbereiten und versuchen die neuen Anforderungen zu erfüllen. Ein Themengebiet, das in der MDR große Beachtung gefunden hat und mit am stärksten von Neuerungen betroffen ist, liegt in den Prozessen nach der Markteinführung der Produkte. Zwar bestanden schon vorher Anforderungen, aber diese wurden durch die MDR geschärft. Auch die Firma WOM, die vorrangig im Bereich der minimal invasiven Chirurgie aktiv ist, muss sich dem Thema widmen, wenn man auch in Zukunft auf diesem Markt aktiv sein will.
...
Das Ziel dieser Arbeit unterteilt sich in zwei Schwerpunkte. Das primäre Ziel besteht darin, die Abweichungen der aktuellen Prozesse zu den neuen Anforderungen der MDR zu ermitteln und einen Prozessentwurf zu erstellen, der mit möglichst wenig Aufwand die Forderungen erfüllt. Dies hilft WOM aktiv dabei, Konformität zur MDR herzustellen, wenn aufgrund abgelaufener Übergangsfristen die Notwendigkeit abschließend gegeben ist. Zu diesem Zweck soll ein visuelles Prozessmodell erstellt werden. Das sekundäre Ziel besteht darin, mit Hilfe der modellierten Prozesse die Schnittstelle zum Forschungs- und Entwicklungsbereich zu analysieren und Möglichkeiten zu ermitteln, wie diese verbessert werden kann. Dabei sollen produktive Lösungen gefunden werden, die sofort eingeführt werden können und damit die Leistungsfähigkeit zeitnah steigern. Eine besondere Rolle spielt hier das neu eingeführte \ac{ALM} Tool Polarion, da dies eine neue Infrastruktur zur Verfügung stellt.
...
Besonders wichtig und interessant ist hierbei die Frage, wo die Grenzen dieses Marktes sind und welche Unternehmen und Produkte tatsächlich betroffen sind. Dazu finden sich in der Regel in den Normen und Standards entsprechende Definitionen, die eine Abgrenzung ermöglichen. Folgend ist ein Beispiel der \ac{GHTF} aus \cite[S. 6]{GHTF2012} gegeben, welches den Begriff "`medizinisches Gerät (Medical Device)"' erläutert.
...
Aus dieser Definition geht klar hervor, dass die oberste Pflicht des Herstellers die Sicherstellung der Sicherheit für die Anwender und Patienten ist. Relativiert wird diese Aussage lediglich durch den Zusatz, dass Risiken immer im Verhältnis zum erwarteten Patientennutzen stehen müssen. Ein hohes Risiko für den Patienten ist somit nur akzeptabel, wenn die durchgeführten Aktionen zu einer bedeutenden Verbesserung des Gesundheitszustandes des Patienten führen. Diese Abwägung findet in einem entsprechenden Evaluierungsprozess vor der Markteinführung statt (vgl. \cite[S. 11]{Ramakrishna2015}). 

Absolute Sicherheit kann nicht garantiert werden, da jedes Gerät bis zu einem gewissen Grad ein Risiko in sich trägt und Fehler unter speziellen Umständen auftreten können. Aufgrund unvorhersehbarer Bedingungskonstellationen können Fehler unerwartet und zufällig auftreten, was selbst durch ausgiebige Tests im Vorfeld nicht ausgeschlossen werden kann. Deswegen wird versucht durch Risikobetrachtungen und -analysen die Gerätesicherheit sicherzustellen, indem die vom Gerät ausgehende Bedrohung durch Risikobewertungen abgeschätzt wird. Diese Form der Betrachtung wird auch unter Risikomanagement subsumiert, das sich in der Regel auf die Erfahrung von Experten für Medizintechnik stützt (vgl. \cite[S. 3]{Cheng2003}). Welchen Stellenwert das Risikomanagement bei Medizinprodukten besitzt, lässt sich schon allein darin erkennen, dass es mit ISO 14971 einen eigenen Standard gibt, der sich mit der Anwendung des Risikomanagements im genannten Kontext beschäftigt (siehe Abbildung \ref{iso_standards}).

Aber nicht nur der Hersteller medizinischer Geräte allein trägt die Verantwortung für die Sicherheit. Jeder der betroffenen Stakeholder, bestehend aus Hersteller, Regierung, Öffentlichkeit/Patient, Benutzer und Verkäufer, trägt einen Teil zur Gewährleistung der Sicherheit bei. Diese Verantwortung ist in Abbildung \ref{qs_shared_resp} veranschaulicht. Die Rolle des Herstellers ist vermutlich am wichtigsten und liegt durch das Design, die Entwicklung und die Produktion des Produktes klar auf der Hand. Die Regierung ist dafür zuständig, dass die in dem jeweiligen Land verfügbaren Geräte sicher und nützlich sind. Der Verkäufer hat als Schnittstelle zwischen Hersteller und Benutzer eine besondere Verantwortung, durch die Überwachung der Konformität zu den regulatorischen Normen und der Bereitstellung des Kundenservices. Der Nutzer des Gerätes wiederum muss sicherstellen, dass er die Funktion des Gerätes erfasst hat und es sicher bedienen kann. Auf den ersten Blick mag es nicht sofort ersichtlich sein, in welcher Weise die Öffentlichkeit und der Patient die Sicherheit beeinflussen können, aber auch der gesellschaftliche Druck auf einen Hersteller zur Erfüllung einer entsprechenden Norm kann am Ende zur Erhöhung der Produktsicherheit beitragen (vgl. \cite[S. 7f.]{Cheng2003}).
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\textwidth]{Images/qs_shared_resp}
\caption[Ideale Bedingungen zur Sicherstellung der Sicherheit medizinischer Geräte]{Ideale Bedingungen zur Sicherstellung der Sicherheit medizinischer Geräte \cite[S. 8]{Cheng2003}}
...
\caption[Standards und Normen für medizinische Geräte]{Standards und Normen für medizinische Geräte \cite[S. 16]{Ramakrishna2015}}
\label{iso_standards_adaption}
\end{figure}

Zu den wichtigsten nationalen Vertretern mit umfassendem Regulierungssystem zählen (vgl. \cite[S. 14]{Ramakrishna2015}):
\begin{itemize}
...
Vor der Markteinführung der Produkte müssen Hersteller die Risiken, die von der Benutzung ihrer Produkte ausgehen, minimieren und die Sicherheit der Patienten gewährleisten. Im Rahmen der Zulassung beziehungsweise Konformitätsbewertung wird dies durch die Behörden und die benannten Stellen kontrolliert (vgl. \cite{Johner2017}). In der Theorie sollten Produktfehler oder Probleme mit den Produkten somit nahezu ausgeschlossen sein. Die Realität sieht jedoch aufgrund der hohen Komplexität der Anwendungsfälle und der eingesetzten Technik anders aus. Fehler können nie komplett ausgeschlossen werden oder vor der Markteinführung verhindert werden und manche Risiken werden erst im Laufe der Zeit bekannt, wenn die Anwender die Produkte täglich einsetzen. Um diesem Problem zu begegnen wird mit \ac{PMS} analytisch nach Problemen der medizinischen Geräte gesucht, die nicht vor Markteinführung erkannt wurden (vgl. \cite[S. 213]{DeMarco2011}).

Anders als in der vorangegangenen \ac{MDD} wird in \cite[Kapitel 1 Artikel 2 60.]{MDR2017} (MDR) eine genaue Definition für PMS gegeben (vgl. \cite[S. 1]{Pugh2017}): 
...
\ac{PMS} (auf Deutsch Überwachung nach dem Inverkehrbringen) hat sowohl für den Hersteller als auch den Benutzer große Bedeutung und verfolgt vielfältige Ziele. Zu den Zielen zählt, die Risiken des Produktes unter realistischen Situationen systematisch zu identifizieren. Bei der Entwicklung von neuen Geräten werden zwar klinische Tests durchgeführt, diese können allerdings verglichen mit dem späteren Einsatz in der Regel maximal als Stichproben gesehen werde. Zudem sollen Produktfehler und unentdeckt gebliebene Sicherheitsprobleme durch die Analysen aufgedeckt werden (vgl. \cite{Johner2017}).

Für den Hersteller ergeben sich tiefe Einsichten in die tatsächlichen Umstände unter denen ihr Produkt agieren muss, was auch die kontinuierliche Aktualisierung der Nutzen-Risiko-Bewertung zulässt. Des Weiteren kann die Leistungsfähigkeit der Produkte "`im Feld"' überprüft werden, was für die Produktverbesserung oder Entwicklung von Folgeprodukten eine wichtige Informationsquelle darstellt. Eines der wichtigsten Ziele ist zudem die Einleitung von notwendigen Maßnahmen für Produktrückrufe (vgl. \cite{Johner2017}).

Zu den möglichen Datenquellen gehören (vgl. \cite[S. 285-288]{Abuhav2012}):
\begin{itemize}
\item Distributoren
...
Weitere Gründe für die Durchführung von PMCF sind (vgl. \cite[S. 287]{Abuhav2012}):
\begin{itemize}
...
Das Vigilanzsystem übernimmt die Rolle des Marktüberwachungs- und Meldesystems. In ihm werden Festlegungen getroffen, wie die Marktüberwachung gewährleistet wird und wie die Vorkommnisse an die zuständigen Behörden kommuniziert werden. Zur Art und Weise der Kommunikation werden von den Institutionen (beispielsweise die Europäische Union durch die MDR) genaue Forderungen und Vorgaben gestellt (vgl. \cite{Johner2017}). Das Ziel ist die Gesundheit und die Sicherheit der Patienten zu schützen, indem Vorfälle bewertet werden und Maßnahmen eingeleitet werden, um Wiederholungen zu verhindern. Außerdem wird die Wirksamkeit der Korrektur- und Präventivmaßnahmen bestimmt und Erfahrungen aus der Überwachung gewonnen (vgl. \cite[S. 1]{Pugh2017}).

Auch das Vigilanzsystem stellt allgemein betrachtet eine Untermenge von PMS dar, da vor diesem Hintergrund ebenso die "`post-market"'-Daten ausgewertet werden. Der Fokus des Vigilanzsystems liegt jedoch dabei auf den reaktiven Tätigkeiten, die von den regulativen Autoritäten und dem Gesetzgeber eingefordert werden. Einen großen Stellenwert hat beispielsweise die Einhaltung von genauen Timelines, die abhängig von der Ausprägung des Zwischenfalls verschiedene Anforderungen stellen (vgl. \cite[S. 1]{Pugh2017}).

Jedes Vorkommnis, das mit einem medizinischen Gerät verbunden ist, das in der EU auftritt, muss vom Hersteller genau untersucht werden, um sicherzustellen, ob es an die entsprechende Autorität berichtet werden muss. Ein solcher Bericht stellt eine der möglichen Maßnahmen des Vigilanzsystems dar. Die zweite Form stellt die \ac{FSCA} dar, die für den Hersteller weitreichende Konsequenzen hat. Verbunden mit einem \ac{FSCA} muss auch ein FSCA-Bericht an die regulative Institution gesendet werden (vgl. \cite[S. 1f.]{Loh2017}).
...
In diesem Teilkapitel wird ein kurzer Überblick über das ALM-Tool Polarion gegeben, um das Verständnis der geplanten Verbesserungen sicherzustellen. Polarion ist ein browserbasiertes Softwareprodukt, das Unternehmen bei der Dokumentation und Strukturierung von Informationen über den gesamten Produktlebenszyklus unterstützt. Das ALM-Tool wurde 2004 von der Firma Polarion Software veröffentlicht. Im Jahre 2016 wurde das Unternehmen Polarion Software durch Siemens PLM Software übernommen (vgl. \cite{PolarionAbout}).

Die Grundidee hinter Polarion besteht darin, Informationen nicht länger in Dokumenten zu pflegen, welche nur schwer verwaltet werden können. Dazu werden die Informationen in atomare Einheiten aufgeteilt und entsprechend ihrer Bedeutung kategorisiert. Diese sogenannten Work Items haben den Vorteil, dass jedes von ihnen mit Meta-Informationen versehen werden kann, die eine größere Detailtiefe bei trotzdem übersichtlicher Darstellung erlaubt. Dabei wird die Stärke bei der Verwendung von Browsern ausgenutzt, indem zusätzliche Informationen einfach per Mausklick mit anschließender Weiterleitung auf eine verlinkte Unterseite abgerufen werden können. Dies lässt sich mit textuellen Bearbeitungsprogrammen nur mühselig umsetzen. In Polarion können Work Items wiederum über Links mit anderen Work Items verbunden werden. Darüber lassen sich komplexe Abhängigkeitsverhältnisse abbilden. Die möglichen Aktionen für den Anwender (z.B. welche Itemkategorien wie miteinander verbunden werden können) lassen sich sehr frei konfigurieren, wodurch die individuellen Anforderungen der Unternehmen bedient werden können.

Die Entwicklung von Produkten und spätere Verwaltung ist geprägt von der Sammlung und Pflege von Anforderungen (Requirements) und der Sicherstellung, ob diese im Rahmen des Projektes erfüllt werden, was durch Tests sichergestellt wird. Konkret auf das weit verbreitete Entwicklungsmodell des V-Modells angewendet, können in Polarion für die verschiedenen definierten Ebenen eigene Itemkategorien definiert werden. Über die Konfiguration kann definiert werden, welche Itemkategorien miteinander verbunden werden können beziehungsweise welche Links bestehen müssen. Dadurch kann definiert werden, dass jedes Work Item auf der einen Ebene eine Verlinkung zu einem entsprechenden Test auf der gleichen Ebene aber auch zu Elementen aus den tiefer liegenden oder höher liegenden Work Items besitzt. Damit kann die Traceability, die bei händisch gepflegten Dokumenten sehr mühsam nachzuweisen und zu pflegen ist, sehr einfach hergestellt werden. Dies hat für WOM eine besonders hohe Bedeutung, da die manuelle Pflege von Anforderungs-, Design- und Testdokumenten mittlerweile aufgrund der gestiegenen Komplexität und der bestehenden normativen Anforderungen zu einer zusätzlichen Belastung der Entwicklungskapazitäten geführt hat.

Aus diesem Grund wurde das Tool zur Unterstützung der Dokumentation von Anforderungen und Tests eingeführt. Eine wesentliche Funktion von Polarion besteht darin, dass die erarbeiteten Work Items in virtuellen Dokumentenebenen im Polarion-Projekt abgelegt und gepflegt werden. Die Work Items landen somit nicht nur in einem virtuellen Container, sondern lassen sich definierten Dokumenten zuweisen, die sich auch in gängigen Formaten exportieren lassen, was besonders bei der Ablage der Entwicklungsdokumentation oder der Kommunikation mit den Kunden große Vorteile bietet. Zudem wird dadurch die dokumentenbasierte Denkweise in das Tool überführt, da die definierten und mit entsprechenden Work Items gefüllten Dokumente einen zusammenhängenden Status besitzen, was den Freigabeprozess auf Dokumenten auch im Tool zulässt. Für die Sicherstellung der Normkonformität im Rahmen der Entwicklung wurden zudem die Erweiterungen MedPack und RiskPack von der Firma Medsoto eingerichtet. Das MedPack liefert dabei entsprechende Erweiterungen, um eine Entwicklung nach IEC 62304 sicherzustellen (vgl. \cite{MedsotoMed}) während sich das RiskPack mit der Erfüllung der Anforderungen nach ISO 14971 beschäftigt (vgl. \cite{MedsotoRisk}). Durch die Erweiterungen von Medsoto wird im Wesentlichen der Konfigurationsaufwand verringert, da durch die getroffenen Einstellungen eine normkonforme Dokumentation unterstützt wird, was das oberste Ansinnen von WOM darstellt. 
...
Die Recherche in \cite{Hesse} liefert eine ausführliche Liste mit möglichen Programmen. Nach ausgiebiger Prüfung der einzelnen Vertreter fällt die Wahl auf den Bizagi BPM Modeler \cite{Bizagi}, der alle Anforderungen erfüllt.

\section{Durchführung}\label{sec:durchfuehrung}
Nachdem in der Planungsphase grundlegende Festlegungen getroffen wurden, kann die Analyse der derzeitigen Prozesse begonnen werden. Ein mögliches Vorgehen bei der Modellierung von Geschäftsprozessen wird in \cite[S. 13-17]{Jacka2009} beschrieben und besteht aus den folgenden Schritten:
\begin{enumerate}
...
\def\SimpleTableEntry#1#2{\scriptsize #1 & \scriptsize #2 \\}
\begin{table}[ht]
\begin{center}
\begin{tabular}{|p{0.6\textwidth}|p{0.3\textwidth}|}
\hline
\SimpleTableEntry{Trigger Event}{Prozessname}
\hline\hline
\SimpleTableEntry{Kunde meldet Problem mit Produkt}{Kundenrückmeldung}
\hline
\SimpleTableEntry{Normative Anforderung zur zyklischen Aktualisierung der klinischen Evaluation}{Aktualisierung der klinischen Bewertung}
\hline
\SimpleTableEntry{Normative Anforderung den Markt dauerhaft zu beobachten}{Marktbeobachtung}
\hline
\SimpleTableEntry{Produkt muss zurückgerufen werden}{Rückrufaktion, Korrekturmaßnahme im Feld}
\hline
\SimpleTableEntry{Fehler im Produkt aufgetreten, weswegen Meldepflicht besteht}{Meldesystem}
\hline
\end{tabular}
...
Die nächsten beiden Schritte Datenerfassung und Interview beschäftigen sich mit der Problemstellung, im Kontext der Prozesserhebung die notwendigen Daten zur Prozessmodellierung zu sammeln. Als Hersteller von Medizintechnik ist WOM verpflichtet nach einem Handbuch für das Qualitätsmanagement zu arbeiten (vgl. \cite[S. 51ff.]{Ramakrishna2015}). In diesem Handbuch sind die Geschäftsprozesse verteilt über Richtlinien und Verfahrensanweisungen dokumentiert. Da die Auditierungen, die durch die benannte Stelle durchgeführt werden, unter anderem auf dem QM-Handbuch erfolgen, wird dieses als vorrangige Quelle für die zu modellierenden Prozesse ausgewählt. Dies bedeutet auch, dass etwaige Abweichungen, die sich aus der Befragung der mit den Aufgaben betrauten Mitarbeiter ergeben, ignoriert werden. Mitarbeiterinterviews dienen lediglich als Abgleich und zur Sicherstellung des Verständnisses für die gewonnen Daten. Die Interviews finden mit dem Fachbereichsleiter des Qualitätsmanagement statt, der die Hauptverantwortung über die analysierten Teile des QM-Handbuches besitzt und mit seinem generellen Überblick die Interpretation der Dokumente bestätigen kann. Zudem wird die Konformität der modellierten Prozesse mit den Dokumenten bezogen auf die normativen Anforderungen der Meldepflicht durch Mitarbeiter der Abteilung Regulatory Affairs verifiziert, da diese in diesem speziellen Teilbereich die entscheidende Instanz bei WOM darstellen.
...
\hline
\SimpleTableEntry{Abkürzung}{Auflösung}
\hline\hline
\SimpleTableEntry{CEO}{Chief Executive Officer}
\hline
\SimpleTableEntry{CFO}{Chief Financial Officer}
\hline
\SimpleTableEntry{CS}{Customer Service}
\hline
\SimpleTableEntry{DFV}{Durchführungsverantwortlicher}
\hline
\SimpleTableEntry{F\&E}{Forschung und Entwicklung}
\hline
\SimpleTableEntry{PJL}{Projektleiter}
\hline
\SimpleTableEntry{PM}{Produktmanagement}
\hline
\SimpleTableEntry{QM}{Qualitätsmanagement}
\hline
\SimpleTableEntry{QMB}{Qualitätsmanagementbeauftragter}
\hline
\SimpleTableEntry{RA}{Regulatory Affairs}
\hline
\SimpleTableEntry{UM}{Umweltmanagement}
\hline
\end{tabular}
...
Nachdem die Beanstandung per Telefon, per Fax oder Brief, durch einen Kundenbesuch oder per Warenrücksendung beim Complaint Manager ankommt, führt dieser die initiale Bearbeitung durch, indem beispielsweise eine Beanstandungsnummer zur eindeutigen Identifizierung vergeben wird und weitere Informationen von der Beanstandungsquelle eingeholt werden (\textbf{"`Informationen zu Beanstandung einholen"'}). Dieser Teilprozess ist in Abbildung \ref{modell_informationen_einholen} dargestellt.
\begin{figure}[ht]
\centering
...
\def\requestListTabHead{\begin{center}\begin{longtable}{|p{0.05\textwidth}|p{0.79\textwidth}|p{0.08\textwidth}|} \hline\scriptsize Nr. & \scriptsize Anforderung & \scriptsize Art.\\ \hline\hline}
\def\ListTabBottom{\end{longtable}\end{center}}
\def\ListTabBottomWithCaptionAndLabel#1#2#3{\caption[#1]{#2}\label{#3}\end{longtable}\end{center}}
\def\plainTabularTextWOCount#1#2{\begin{tabular}{p{1cm}}\scriptsize \\\end{tabular} & \begin{tabular}{p{12,85cm}}\scriptsize#1 \\\end{tabular} & \begin{tabular}{p{1cm}}\scriptsize#2 \\\end{tabular}\\}
\def\plainTabularText#1#2{\stepcounter{RequirementNumber}\begin{tabular}{p{1cm}}\scriptsize \theRequirementNumber \\\end{tabular} & \begin{tabular}{p{12,85cm}}\scriptsize#1 \\\end{tabular} & \begin{tabular}{p{1cm}}\scriptsize#2 \\\end{tabular}\\}
\def\tabularitemizeFirstLayer#1#2{\stepcounter{RequirementNumber}\begin{tabular}{p{1cm}}\scriptsize \theRequirementNumber \\\end{tabular} & \begin{tabular}{p{0,01cm}p{12,4cm}}\scriptsize\textbullet & \scriptsize#1 \\\end{tabular} & \begin{tabular}{p{1cm}}\scriptsize#2 \\\end{tabular}\\}
\def\tabularitemizeFirstLayerWOCount#1#2{\begin{tabular}{p{1cm}}\scriptsize \\\end{tabular} & \begin{tabular}{p{0,01cm}p{12,4cm}}\scriptsize\textbullet & \scriptsize#1 \\\end{tabular} & \begin{tabular}{p{1cm}}\scriptsize#2 \\\end{tabular}\\}
\def\tabularitemizeSecondLayer#1#2{\stepcounter{RequirementNumber}\begin{tabular}{p{1cm}}\scriptsize \theRequirementNumber \\\end{tabular} & \begin{tabular}{p{0,01cm}p{0,01cm}p{12cm}}&\scriptsize\textendash & \scriptsize#1 \\\end{tabular} & \begin{tabular}{p{1cm}}\scriptsize#2 \\\end{tabular}\\}
\def\tabularitemizeSecondLayerUncheck#1{\stepcounter{RequirementNumber}\begin{tabular}{p{1cm}}\scriptsize \theRequirementNumber \\\end{tabular} & \begin{tabular}{p{0,3cm}p{0,3cm}p{11,35cm}}\scriptsize&\scriptsize\textendash & \scriptsize#1 \\\end{tabular} & \unchecked\\}
...
\hline
\plainTabularTextWOCount{Plan zur Überwachung nach dem Inverkehrbringen:}{}
...
\hline
\plainTabularTextWOCount{Schwerwiegende Vorkommnisse oder Sicherheitskorrekturmaßnahmen im Feld:}{}
...
\tabularitemizeFirstLayer{Angeforderte Unterlagen müssen bei entsprechenden Anfragen an die Behörden ausgehändigt werden}{89/3}
...
\hline
\plainTabularTextWOCount{Bericht zur Überwachung nach dem Inverkehrbringen/Sicherheitsbericht:}{}
\tabularitemizeFirstLayerWOCount{Klasse I:}{}
...
\tabularitemizeFirstLayerWOCount{Klasse IIa, IIb, III:}{}
\tabularitemizeSecondLayer{Ergebnisse und Schlussfolgerungen der PMS sowie Beschreibung und Begründung ergriffener Präventiv- und Korrekturmaßnahmen müssen enthalten sein (erstellt pro Produkt, gegebenenfalls Produktkategorie oder Produktgruppe)}{86/1}
\tabularitemizeSecondLayer{Aktualisierung des Berichtes über gesamte Lebensdauer}{86/1}
...
\tabularitemizeFirstLayerWOCount{Aktualisierungsintervalle des Berichtes:}{}
...
\tabularitemizeFirstLayerWOCount{Vorlage des Berichtes:}{}
...
\hline
\plainTabularTextWOCount{Trends:}{}
\tabularitemizeFirstLayer{Meldung von statistisch signifikanten (entscheidend ist Vergleich mit erwartetem und in technischer Dokumentation angegebener Häufung) Anstiegen der Häufigkeit oder des Schweregrades nicht schwerwiegender Vorkommnisse oder erwarteter unerwünschter Nebenwirkungen über elektronisches System, wenn Nutzen-Risiko-Analyse erheblich beeinflusst wird und Risiken für die Gesundheit entstehen}{88/1 92/1}
...
\hline
\plainTabularTextWOCount{Klinische Nachbeobachtung nach dem Inverkehrbringen
(PMCF):}{}
...
\tabularitemizeFirstLayer{Durchführung von Studien über klinische Nachbeobachtung nach dem Inverkehrbringen, die von benannter Stelle gefordert werden}{56/3}
\hline
\plainTabularTextWOCount{Analyseaktivitäten der Behörden:}{}
...
\tabularitemizeFirstLayer{Produktstichproben oder Zugang zu Produkten bei gerechtfertigtem Anliegen den Behörden kostenfrei zur Verfügung stellen}{93/3}
\tabularitemizeFirstLayer{Hersteller ergreift erforderliche Korrekturmaßnahmen, wenn Behörden aus der Analyse der Vigilanz-Daten Risiken oder nachteilige Änderungen der Nutzen-Risiko-Abwägung ermitteln und dem Hersteller mitteilen}{90}
...
\begin{center}
\begin{longtable}{|l|p{0.83\textwidth}|}
\hline
Nummer & Status, angepasster Prozess\\
\hline\hline
\LineInTraceTableChecked %1
\LineInTraceTableNotInFocus %2
\LineInTraceTableNotInFocus %3
...
\LineInTraceTableChecked
\LineInTraceTableChecked %10
\LineInTraceTable{Startereignis in PMS-Prozess}
\LineInTraceTableChecked
\LineInTraceTableChecked
\LineInTraceTableChecked
\LineInTraceTable{Einreichung über elektronisches System in Meldesystem-Prozess}
\LineInTraceTable{Neue Fristen in Meldesystem-Prozess}
\LineInTraceTable{Neue Fristen in Meldesystem-Prozess}
\LineInTraceTable{Neue Fristen in Meldesystem-Prozess}
\LineInTraceTable{Einreichung über elektronisches System in Rückrufaktion/Korrekturmaßnahme im Feld}
\LineInTraceTableChecked %20
\LineInTraceTable{Hinweis, dass periodische Sammelmeldung verwendet werden sollte, wenn möglich in Rückrufaktion/Korrekturmaßnahme im Feld}
\LineInTraceTableChecked
\LineInTraceTable{Zusätzliche Interaktion mit Behörden in PMS-Prozess}
\LineInTraceTable{Hinweis, dass Untersuchungen mit Behörden gegebenenfalls abzustimmen sind in PMS-Prozess}
\LineInTraceTable{Interaktion zu angeforderten Unterlagen mit Behörden in PMS-Prozess}
\LineInTraceTable{Einreichung Abschlussbericht über elektronisches System in Rückrufaktion/Korrekturmaßnahme im Feld}
\LineInTraceTable{Neue Prozessschritte in Rückrufaktion/Korrekturmaßnahme im Feld}
\LineInTraceTable{Neue Prozessschritte in Rückrufaktion/Korrekturmaßnahme im Feld}
\LineInTraceTable{Neue Prozessschritte in Rückrufaktion/Korrekturmaßnahme im Feld}
\LineInTraceTable{Neue Prozessschritte in Rückrufaktion/Korrekturmaßnahme im Feld} %30
\LineInTraceTable{Startereignis in PMS-Prozess}
\LineInTraceTable{Neuer Prozess Meldung zu schwerwiegendem Vorkommnis von Behörde erhalten}
\LineInTraceTable{Keine entsprechenden Produkte im Portfolio}
...
\LineInTraceTable{Neuer Prozess für zyklischen PMS Bericht}
\LineInTraceTable{Neuer Prozess für zyklischen PMS Bericht}
\LineInTraceTable{Keine entsprechenden Produkte im Portfolio} %40
\LineInTraceTable{Keine entsprechenden Produkte im Portfolio}
\LineInTraceTable{Neuer Prozess für zyklischen PMS Bericht}
\LineInTraceTable{Keine entsprechenden Produkte im Portfolio}
\LineInTraceTable{Keine entsprechenden Produkte im Portfolio}
...
\LineInTraceTable{Startereignis in PMS-Prozess}
\LineInTraceTable{Neuer Prozess Interaktion mit den Behörden}
\LineInTraceTable{Neuer Prozess Interaktion mit den Behörden} %70
\LineInTraceTable{Neuer Prozess Interaktion mit den Behörden}
\LineInTraceTable{Neuer Prozess Interaktion mit den Behörden}
\LineInTraceTable{Startereignis in PMS-Prozess}
...
%===================================================================== Chapter 5
\def\FE{F\&E-Bereich }
\chapter{Analyse und Verbesserung der Schnittstelle: PMS-Prozesse und F\&E}\label{chap:Schnittstelle}
Dieses Kapitel befasst sich mit der Anpassung der identifizierten Unternehmensprozesse auf der Grundlage des erstellten Modells. Der Fokus liegt aber nicht auf der Erfüllung von gesetzlichen und normativen Anforderungen, sondern auf der Steigerung der Effektivität der Schnittstelle F\&E und der Prozesse nach der Markteinführung. Der Auslöser ist somit keine regulative Anpassung sondern bestehende Missstände in den Unternehmensprozessen. Konkret geht es dabei um die Schnittstelle zwischen dem Complaint Management (Bearbeitung von Kundenrückmeldungen) und dem Forschungs- und Entwicklungsbereich. Einige der in diesem Zusammenhang durchgeführten Aktionen (Teilprozesse und Prozessausschnitte der modellierten Prozesse) sind durch die Prozessbeschreibungen (Verfahrensanweisungen und Richtlinien) nicht näher dokumentiert, wodurch die gelebte Praxis von den individuellen Vorgehensweisen der Mitarbeiter bestimmt wird. Dies schmälert allerdings die Leistungsfähigkeit der Prozesse. Um den aktuellen Zustand zu verbessern soll zudem besonders berücksichtigt werden, in welcher Form das vor kurzem im Unternehmen eingeführte ALM-Tool Polarion Abhilfe schaffen kann.

\section{Identifikation der Prozessschwachstellen}\label{sec:Identifikation}
Die Identifikation der Schwachstellen wird auf zwei Wegen durchgeführt. Zum einen wird das erstellte Prozessmodell untersucht und auf mögliche Probleme analysiert. Zum anderen werden Interviews mit Projektleitern aus dem \FE durchgeführt, da diese als einzige auf der Seite der F\&E von der Schnittstelle betroffen sind. Prinzipiell werden alle bisher im Rahmen dieser Arbeit modellierten Prozesse für die Analyse berücksichtigt.

Eine kurze Analyse des gesamten Prozessmodells (also alle in Kapitel 3 modellierten Prozesse) zeigt, dass lediglich der Prozess zur Bearbeitung von Kundenrückmeldungen mit all seinen Unterprozessen die zu untersuchende Schnittstelle implementiert. Dadurch ist klar, dass sich die folgenden Betrachtungen auf diesen Prozess fokussieren können. Die Analyse des Modells erweckt den Eindruck, dass der \FE eine eher untergeordnete Rolle für die Bearbeitung von Kundenrückmeldungen spielt. In der Fehlerursachenanalyse einer Kundenrückmeldung kann es dazu kommen, dass Einschätzungen vom \FE notwendig sind. Außerdem spielt der Bereich bei der Ausführung von festgelegten Maßnahmen zur Behebung des Complaints eine Rolle. Beispielsweise müssen durchzuführende Änderungen am Produkt naturgemäß in diesem Bereich durchgeführt werden. Aber auch die Anpassung der Risikoeinschätzung wird in diesem Funktionsbereich durchgeführt. Einen Grund für Verbesserung liefert diese Analyse jedoch nicht, da augenscheinlich auch kein Problem in der aktuellen Form der Prozesse liegt. Im Gegenzug erscheinen diese sehr schlüssig, da durch die Prozesse nur die notwendigsten Aufgaben in den \FE weitergegeben werden.

Die Befragung der Projektleiter zeigt dennoch Verbesserungspotential auf, was durch die reine Analyse des Prozessmodells aufgrund des Betrachtungshorizontes nicht sichtbar war. Eine wesentliche Schwäche ergibt sich aus der momentanen Sichtweise auf die Rückwirkung der Prozesse nach dem Inverkehrbringen auf die Produktanforderungen. Während der Entwicklung der Produkte und speziell bei Weiterentwicklungen oder Produktentwicklungen auf dem Plattformkonzept werden häufig die Gründe für ursprüngliche Produktanforderungen hinterfragt. Wurden diese aufgrund von Änderungsvorgängen, die auf Kundenrückmeldungen basierten, angepasst, ist dies im Nachhinein nicht mehr leicht zu erkennen. Dies führt am Ende dazu, dass die Herkunft der Anforderungen nicht transparent ist. Im schlimmsten Fall werden solche Anforderungen wieder entfernt oder angepasst, wodurch bereits gelöste Probleme in der Folge wieder auftreten können. Die Folge sind Qualitätsprobleme, die hätten vermieden werden können. Eine mögliche Verbesserung besteht somit darin, dass für die Produktanforderungen und Produkttests transparenter zu erkennen sein sollte, aus welchen Gründen diese angepasst oder erstellt wurden und ob dafür entsprechende Feldinformationen mit eventuell angeschlossenen Untersuchungsberichten verfügbar sind.
...
In Kapitel \ref{sec:Identifikation} wurden zwei Möglichkeiten zur Verbesserung der aktuellen Prozesse aufgrund bestehender Schwachstellen identifiziert. Um den Rahmen dieser Arbeit nicht zu sprengen, wird entschieden nur eine der beiden Möglichkeiten umzusetzen. Es ist zu erwarten, dass die zweite genannte Möglichkeit, die die Verfeinerung und Überarbeitung des Prozesses zum Einholen der Informationen vom \FE betrachtet, sehr umfangreich ist und einige Risiken bietet. Die Risiken liegen zum einen darin, dass von den Änderungen mehrere Unternehmensbereiche betroffen wären, was aufwendige Interessensabgleiche zur Konsensfindung erfordern würde. Zum anderen sollte die Lösung auf der Verwendung des neuen ALM-Tools basieren, dessen Einsatz derzeit nicht für das Complaint Management vorgesehen ist. Die Umsetzung und Einführung einer entsprechenden Lösung wäre somit langwieriger, da beispielsweise auch der Schulungsaufwand berücksichtigt werden müsste.

Im Gegenzug erfüllt die erste mögliche Prozessverbesserung mit einer zu erwartenden einfachen Umsetzung bei gleichzeitig hohem Benefit die Kriterien, die die Umsetzung im Rahmen dieser Arbeit bedingen. Es soll somit ein Konzept erstellt werden, das die Traceability von aufgetretenen Vorkommnissen und Kundenrückmeldungen zu Änderungen der Produktanforderungen und Tests in beide Richtungen sicherstellt. Das bedeutet, dass es möglich sein soll, zu ermitteln, welche Änderungen beispielsweise als Folge von Kundenrückmeldungen getroffen wurden. Gleichzeitig soll aus einem Requirement-Item selbst auch hervorgehen, welche Kundenrückmeldungen zu Anpassungen der entsprechenden Anforderungen geführt haben.

Die erste genannte Informationsflussrichtung von der Feldrückmeldung zu den Produktanforderungen ist derzeit durch das elektronische System (SAP) abgebildet. Für eingetroffene Kundenrückmeldungen wird durch den Complaint Manager, wie in Kapitel \ref{sec:ergebnisse_modellierung} angesprochen wurde, eine Beanstandungsnummer vergeben. Sind Änderungen am Produkt oder an der technischen Dokumentation des Produktes notwendig, wird ein entsprechender Änderungsvorgang ausgelöst. Dieser wird in der elektronischen Darstellung der Beanstandung referenziert. Der Änderungsvorgang ist wiederum ein eigener sehr gut erfasster und festgelegter Prozess, in dessen Bearbeitung Unterlagen über die durchgeführten Änderungen erstellt werden. In den von den Änderungen betroffenen Dokumenten wird in der Dokumentenhistorie ein Verweis auf den bearbeiteten Änderungsvorgang eingefügt, was aber nicht immer konsequent durchgeführt wird und demzufolge nicht verlässlich ist. Durch einen Vorher-Nachher-Vergleich, der auch auf den Dokumenten vor der Tooleinführung möglich aber sehr aufwendig war, war die Traceability von der Kundenrückmeldung auf oberster Ebene zu den Änderungen auf unterster Ebene der Produktdokumentation sichergestellt. Einfach gesagt, ist es demzufolge möglich, festzustellen, welche Änderungen durchgeführt wurden, wenn bekannt ist, wonach zu suchen ist, unter dem Vorbehalt, dass alle Verweise auf die Änderungsvorgänge in den Dokumentenhistorien korrekt angelegt wurden. Die Traceability vom Requirement zur Kundenrückmeldung über den Änderungsvorgang ist zwar auch möglich, aber ungleich schwieriger und zeitraubender, da dafür alle Änderungsvorgänge zunächst überprüft werden müssten, ob diese möglicherweise zu entsprechenden Anpassungen führen können. Anschließend müsste für jeden der Änderungsvorgänge separat geprüft werden, welche Änderungen dafür durchgeführt wurden. Der Blick von "`unten nach oben"' ist somit weit schwieriger. Aber gerade diese Perspektive hat eine hohe Bedeutung im F\&E-Bereich, da Requirements im Rahmen der Entwicklung, Weiterentwicklung oder Abwandlungsentwicklung häufig hinterfragt werden. Teilweise sind lange Kausalketten oder spezielle Szenarien, die zu den entsprechenden Anpassungen geführt haben, nicht ad-hoc verfügbar, was Fehlentscheidungen oder aufwendige Recherchen zur Folge haben kann.

Um diese Situation zu verbessern, wird die itembasierte Arbeitsweise von Polarion ausgenutzt. Wie bereits angesprochen wurde, werden im neuen System zwar auch Dokumente gepflegt, aber diese setzen sich aus einzelnen Anforderungen und Informationseinheiten mit eigenen Metainformationen und möglichen Verlinkungen zu anderen Elementen zusammen. Somit ist es möglich für einzelne Elemente zusätzliche Verlinkungen anzulegen. Da zudem für jedes Work Item eine Änderungshistorie erstellt wird, kann im Nachhinein sehr komfortabel ermittelt werden, welche Änderungen im Zusammenhang mit welcher hergestellten Verlinkung durchgeführt wurden. In diesem Kontext kommt mit der Pflicht zur Durchführung eines Risikomanagements eine Besonderheit im Medizintechniksektor zum Tragen, da die Anpassung von Risikoeinschätzungen häufig eine Ursache für Änderungen an der Produktdokumentation oder den Produktanforderungen darstellt. Nach der Aktualisierung der Einschätzungen wird gegebenenfalls ein Änderungsvorgang ausgelöst, der dann die tatsächlichen Änderungen herbeiführt. 

Die konkrete Lösung des Problems sieht vor, neue Möglichkeiten zur Verlinkung von Änderungen an den Risikoeinschätzungen und den Produktanforderungen zu entsprechenden Kundenrückmeldungen und ausgelösten Änderungsvorgängen zu schaffen. Zu diesem Zweck werden zwei neue Work Items eingeführt, die in keinem der vorgesehenen virtuellen Dokumente enthalten sein sollen. Somit wird für eine relevante Kundenrückmeldung (Complaint), die zu Anpassungen im System führt, ein Eintrag mit der jeweiligen Beanstandungsnummer angelegt. Des Weiteren wird ein ähnliches Work Item für Änderungsvorgänge eingeführt, die ebenfalls eine eindeutige Nummer besitzen, über die sie jederzeit auch in anderen im Unternehmen verwendeten digitalen Systemen (z.B. SAP) identifiziert werden können. Die neuen Work Items und die Verlinkung zu ihnen sollen durch die Systemarchitekten oder Projektleiter angelegt werden. In den dadurch möglichen Verlinkungen besteht der tatsächliche Mehrwert der Work Items, da dadurch kausale Zusammenhänge festgelegt werden können, die die beschriebenen Probleme lösen.

Um eine möglichst gebräuchliche Lösung für die Praxis zu finden, werden an dieser Stelle die möglichen Szenarien für Produktänderungen näher analysiert. Das Ergebnis ist in Abbildung \ref{process_constellations_wom} zu sehen. Auf der linken Seite befindet sich eine einfache Darstellung des Prozesses für Kundenrückmeldungen, der auf die wichtigsten möglichen Interaktionen mit dem \FE komprimiert wurde. Dabei ist ersichtlich, dass es mit der Durchführung von Untersuchungen, der Risikoeinschätzung und der Durchführung von Änderungsvorgängen drei mögliche Interaktionsformen gibt, die unabhängig voneinander ablaufen können. Auf der rechten Seite sind alle möglichen Konstellationen aufgezeigt, wie Vorkommnisse durch den \FE bearbeitet werden können. Die nach dem neuen Vorgehen für die jeweilige Konstellation resultierenden Aktionen sind zudem am rechten Rand in grau aufgelistet. Für die Aktualisierung von Requirements und den an dieser Stelle nicht näher erwähnten aber trotzdem mit ihnen verbundenen Tests muss ein Änderungsvorgang ausgelöst werden, der anschließend mit den geänderten Work Items verlinkt werden kann. Anpassungen der Risikoeinschätzungen basieren auf konkreten Vorkommnissen, die über die Beanstandungsnummer verlinkt werden sollen. Für Analysen durch den \FE werden derzeit keine Links oder weitere Unterstützung durch das Tool vorgesehen, was am Anfang dieses Abschnitts bereits näher erläutert wurde.
\afterpage{
\clearpage
\begin{figure}[p]
\centering
\includegraphics[height=0.9\textheight]{Images/process_constellations_wom}
\caption[Prozesskonstellationen für Vorkommnisse mit F\&E-Interaktion]{Prozesskonstellationen für Vorkommnisse mit F\&E-Interaktion}
\label{process_constellations_wom}
\end{figure}
\clearpage
}
...
Aus den ermittelten Konstellationen ergeben sich keine nennenswerten Besonderheiten, die eine komplizierte Lösung auf Seiten von Polarion erfordern. Demzufolge kann über das Anlegen der zwei neuen Work Items und der Definition der möglichen zu erstellenden Links die neue Funktionalität implementiert werden.
...
Die für den ersten Aufgabenteil notwendigen durchgeführten Änderungen können in Abbildung \ref{new_config_items} eingesehen werden. Über die rote Markierung wird verdeutlicht, welche Einträge hinzugekommen sind. Zum einen ist das der Eintrag für einen Complaint und zum anderen der neue Eintrag für einen Änderungsvorgang. Jede Zeile steht für ein neues Element und wird beschrieben über einen Identifikationstext für Polarion in der ersten Spalte und einem Aliastext, unter dem ein entsprechendes Work Item für den User dargestellt wird. Zudem wird noch ein Symbol gewählt und die Bedeutung durch einen kurzen Beschreibungstext definiert.
\begin{figure}
\centering
\includegraphics[width=1\textwidth]{Images/new_config_items}
\caption[Konfigurationsänderung für die zwei neuen Work Items]{Konfigurationsänderung für die zwei neuen Work Items}
\label{new_config_items}
\end{figure}

In einem weiteren Schritt, wird festgelegt, welche Daten in den neuen Work Items enthalten sind. Also welche Datenstrukturen vom System über Eingabemasken erfasst werden können. Bestimmte Standardattribute wie Status, Priorität oder Beschreibung, die in jeder Itemkategorie enthalten sein müssen, sind durch eine separate Konfiguration festgelegt und müssen demnach nicht für jede Kategorie neu definiert werden. Die itemspezifische Konfiguration, die für beide neuen Work Items gleich ist, ist in Abbildung \ref{new_config_items_fields} ersichtlich. Da vorerst der Mehrwert der Work Items in der Möglichkeit besteht, eine Verbindung zu diesen zu definieren, besitzen sie lediglich einen Eingabetext, über den sie eindeutig definiert sind. Sowohl für Änderungsvorgänge als auch für Complaints werden bei WOM eindeutige Nummern vergeben, die an dieser Stelle als ID definiert werden und bei der Neuanlage eines solchen Work Items zwingend eingegeben werden müssen. Ein mögliches Beispiel ist in Abbildung \ref{complaint_item_example} ersichtlich. Neben den allgemeinen Informationen, die in jedem Work Item zu finden sind (oberer Bereich), besteht der individuelle Inhalt des Work Items, wie bereits erwähnt wurde, aus der ID.
\begin{figure}[ht]
\centering
\includegraphics[width=1\textwidth]{Images/new_config_items_fields}
\caption[Definierte Datenfelder der neuen Work Items]{Definierte Datenfelder der neuen Work Items}
\label{new_config_items_fields}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.6\textwidth]{Images/complaint_item_example}
\caption[Beispiel für ein neues Complaint-Item]{Beispiel für ein neues Complaint-Item}
\label{complaint_item_example}
\end{figure}

Um die gewünschten Verbindungen zwischen den Work Items zu ermöglichen, müssen diese definiert werden. Dies geschieht ebenfalls über die Konfiguration in Polarion. In der oberen Hälfte von Abbildung \ref{new_config_links} ist zu erkennen, dass eine neue Verbindungsklasse definiert wurde. Im ersten Feld wird mit "`changes"' die Text-ID für Polarion festgelegt, unter der die neue Verbindung im System erstellt wird. Diese Verbindung wird dann durch einen Aliastext für beide Richtungen definiert, da Verbindungen im System immer in beide Richtungen angezeigt werden. In der unteren Hälfte wird definiert, zwischen welchen Work Items die neue Form der Verbindung zulässig ist. An dieser Stelle werden die beiden neuen zuvor definierten Work Items ausgewählt und festgelegt, dass alle anderen Work Items damit verbunden werden können. Eine weitere Einschränkung wird an dieser Stelle bewusst nicht durchgeführt, da die Rückwirkung von Complaints und Änderungsvorgängen sehr vielfältig ist und sich für jeden Itemtyp ein mögliches Szenario erdenken lässt, in dem ein entsprechender Link Sinn macht. Die durchgeführten Änderungen sind in der Abbildung rot umrahmt.
\begin{figure}
\centering
\includegraphics[width=1\textwidth]{Images/new_config_links}
\caption[Konfigurationsänderung für die Verlinkungen zu den zwei neuen Work Items]{Konfigurationsänderung für die Verlinkungen zu den zwei neuen Work Items}
\label{new_config_links}
\end{figure}

Über die Änderungen ist es ab jetzt möglich, die zwei neu erstellten Work Items mit den anderen Work Items der Produktanforderungen und Produktdokumentation zu verknüpfen. Wie eine solche Verbindung am Ende aussieht, ist in Abbildung \ref{detail_view_connected_complaint} ersichtlich. In der Detailansicht des Complaint-Items ist zu sehen, dass eine Verbindung zwischen dem Complaint und dem Test-Item (Requirement) 72 besteht, die vom Typ "`changes"' ist.
\begin{figure}
\centering
\includegraphics[width=1\textwidth]{Images/detail_view_connected_complaint}
\caption[Beispiel für die Verbindung zu den neuen Itemkategorien]{Beispiel für die Verbindung zu den neuen Itemkategorien}
\label{detail_view_connected_complaint}
\end{figure}

In Polarion besteht zudem die Möglichkeit sogenannte Workflows zu definieren. Mit diesen kann festgelegt werden, welche verschiedenen Status ein Work Item besitzen kann und wie ein Zustandswechsel erreicht werden kann. Eine entscheidende Rolle spielen dabei die Rollen, die durch die Benutzer des Systems ausgeführt werden. Ein Beispiel wäre, dass ein Requirement die beiden Zustände "`in Bearbeitung"' und "`Freigegeben "' besitzt. Dafür kann festgelegt werden, dass der Zustandswechsel nur durch den Systemarchitekten ausgeführt werden kann, da er die entsprechende fachliche Verantwortung für diese Aufgabe besitzt. Durch die Workflows ist es demnach möglich, festgelegte Schrittfolgen im System sicherzustellen.

Während der gesamten Einführungsphase von Polarion wurde die Strategie verfolgt möglichst wenige Restriktionen zu verwenden, um die Akzeptanz bei der Einführung nicht durch zu strikte und in den Augen der Nutzer vielleicht unnötige Regeln zu gefährden. Aus diesem Grund macht es auch für die neuen Anpassungen keinen Sinn, in der frühen Phase feste Workflows zu definieren.

Die momentan vorliegende Prozessbeschreibung (bestehend aus Verfahrensanweisungen und Richtlinien) besitzt einen relativ abstrakten Betrachtungshorizont, der kleinere Details bei der Umsetzung den individuellen Vorgehensweisen der Mitarbeiter überlässt. Vor diesem Hintergrund wird entschieden das Anlegen der neuen Verbindungen in Polarion darin nicht zu beschreiben, weswegen dort keine Anpassungen notwendig sind. Dies wäre zudem schon sehr unlogisch, da selbst die Verwendung von Polarion darin bisher nicht angemerkt wird.

%===================================================================== Schluss
\chapter{Schluss}
\section{Zusammenfassung}\label{sec:Zusammenfassung}
Die gestellte Arbeitsaufgabe bestand darin, sowohl die Konformität der Prozesse nach dem Inverkehrbringen mit der MDR zu erzielen als auch eine allgemeine Verbesserung der Prozesse auf Seiten der Forschung und Entwicklung zu erwirken, da die Schnittstelle zwischen dem Complaint Management und dem F\&E-Bereich aktuell Verbesserungspotentiale in Bezug auf Effizienz aufweist. Für die durchzuführenden Arbeiten sollte Geschäftsprozessmodellierung dienen. Konkret wurde somit zunächst mit BPMN 2.0 eine visuelle Darstellung der Prozesse erstellt, was klare Vorteile bei Anpassungs- und Adaptionsvorgängen von Geschäftsprozessen aufweist. Bevor jedoch mit der Anpassung der Prozesse begonnen werden konnte, musste geklärt werden, welche Anpassungen tatsächlich notwendig sind. Dazu war es notwendig, die Anforderungen der MDR zu erfassen, was eine ausgiebige Analyse erfordert hat. Am Ende der Analyse stand eine Liste von Anforderungen (Checkliste), mit der am Prozessmodell geprüft werden konnte, welche Anforderungen noch nicht erfüllt sind. Anschließend wurden für die ermittelten umzusetzenden Anforderungen Möglichkeiten der Implementierung erarbeitet und die Änderungen danach durchgeführt. Diese Änderungen wurden im erstellten Prozessmodell durchgeführt.

Zur Verbesserung der F\&E-Interaktion mit zum Beispiel dem Complaint Management wurde ebenfalls das erstellte Prozessmodell analysiert. Auf dieser Grundlage wurden die aktuell bestehenden Probleme für den Entwicklungsbereich ermittelt und mögliche Verbesserungen in Absprache mit den Projektleitern im Unternehmen besprochen. Das größte Problem offenbarte sich dabei in der fehlenden rückwärts gerichteten Traceability (ausgehend von den Requirement und Risiko Items) zu den Kundenrückmeldungen beziehungsweise gemeldeten Vorkommnissen. Durch Anpassung der Strukturen im neu eingeführten ALM-Tool Polarion, wurde die Möglichkeit geschaffen diese fehlende Vernetzung abzubilden.

\section{Diskussion}\label{section:Diskussion}
Bei der Analyse der Prozesse zeigte sich, dass der Einsatz von grafischer Modellierung einen sehr positiven Einfluss auf die Ableitung von konkret notwendigen Anpassungen hat. Durch die initiale Überführung der Prozesse in das Modell, konnten die ermittelten Anforderungen wesentlich leichter überprüft werden, da ein wesentlich besserer Überblick gegeben war. Ohne das grafische Modell, wären aufwendige Suchen nach Textstellen notwendig, denn nach eingehender Analyse der Unterlagen ist es zwar möglich, einen Eindruck zum Ablauf der Prozesse zu erarbeiten aber die Ermittlung von Textstellen, die angepasst werden müssen, gestaltet sich sehr schwierig. Dieser Umstand wird durch die Verteilung der Prozessbeschreibung über verschiedene Quellen, die in Prosatext geschrieben sind, zusätzlich erschwert. Durch die zeitliche relative Determiniertheit der grafischen Darstellung (also die Festlegung der zeitlichen Reihenfolge) ist zudem viel leichter einschätzbar, an welcher Stelle im Prozess Ergänzungen oder Anpassungen durchgeführt werden müssen. Die Überführung der Verfahrensanweisungen in grafische Prozessmodelle bringt somit viele Vorteile, da zudem bei der Analyse und Modellierung die Unklarheiten und Interpretationsspielräume auffällig werden und am Ende eindeutigere Prozessbeschreibungen erreicht werden können.

Generell ist darauf hinzuweisen, dass bei der aktuell gegebenen und der zu erwartenden steigenden Komplexität der reine prozessorientierte Ansatz, bei dem die Unternehmensprozesse auf die Bedürfnisse der Stakeholder abgestimmt werden, für WOM unausweichlich ist. Der momentane Zustand mit dem Handbuch, was aus Richtlinien und Verfahrensanweisungen besteht, weist zwar an vielen Stellen große Parallelitäten zu reinen Prozessbeschreibungen auf, aber dieser Gedanke ist nicht konsequent berücksichtigt. Dies führt teilweise zu Aufzählungen von Tätigkeiten und Anforderungen im Prosatext, denen aber keine eindeutige zeitliche Basis zugrunde liegt, woraus viel Spielraum für Interpretationen entsteht.

Außerdem fällt auf, dass manche Prozesse in ihrer Definition nicht eindeutig sind. So kümmert sich beispielsweise das Meldesystem (Richtlinie 04) um die Durchführung von Korrekturmaßnahmen, obwohl dafür der Prozess für den Rückruf und die Korrekturmaßnahmen im Feld existiert. Falls der Gedanke dahinter in der Sicherstellung der zeitnahen Auslösung von Korrekturmaßnahmen liegt, sollte das komplette Prozessmodell in diesem Kontext überdacht werden. Andernfalls besteht Redundanz im Prozess, da an verschiedenen Stellen Maßnahmen initiiert werden, was höchstens durch vorgeschaltete Überprüfungen, ob beispielsweise schon Maßnahmen ergriffen wurden, abgefangen werden kann. Solche Prüfungen sind im aktuellen Stand der Unterlagen nicht eingeplant, wodurch diese auf dem Verständnis und der Sorgsamkeit der Mitarbeiter beruhen. Die Leistungsfähigkeit der Prozesse leidet darunter, was nicht zur Schaffung eines Wettbewerbsvorteils aufgrund effektiver Prozesse beiträgt.

Im Allgemeinen ist zu sagen, dass das erstellte Prozessmodell lediglich einen Entwurf auf der Grundlage der Prozessdokumentation darstellt. Es ist folglich damit zu rechnen, dass dies nicht an allen Stellen dem tatsächlich gelebten Prozess entspricht. Hier müsste in einer weiteren Analyse mit den betroffenen Instanzen im Detail nochmals durchgesprochen werden, inwiefern noch Änderungen vor allem im praktischen Einsatz durchzuführen sind, da durch die Richtlinien und Verfahrensanweisungen teilweise ein sehr hoher Spielraum besteht. Danach muss zudem geprüft werden, ob sich aus den eventuell möglichen Abweichungen auch neue Einschätzungen bezogen auf die Erfüllung der Anforderungen der MDR ergeben.
...
\def\unchecked{\parbox[c]{1em}{\includegraphics[width=0.75cm]{Images/checkbox_unchecked}}}
\def\checked{\parbox[c]{1em}{\includegraphics[width=0.75cm]{Images/checkbox_checked}}}

\newcounter{ChecklistNumber}
\def\checkListTabHead{\begin{center}\begin{longtable}{|p{0.05\textwidth}|p{0.82\textwidth}|p{0.05\textwidth}|} \hline\scriptsize Nr. &\scriptsize Anforderung &\scriptsize Erfüllt\\ \hline\hline}
\def\plainTabularTextWOCheckbox#1{& \begin{tabular}{p{13,75cm}} \scriptsize#1 \\\end{tabular} & \\}%{ #1 & \\}
\def\plainTabularTextChecked#1{\stepcounter{ChecklistNumber}\begin{tabular}{p{1cm}}\scriptsize \theChecklistNumber \\\end{tabular} & \begin{tabular}{p{13,35cm}} \scriptsize#1 \\\end{tabular} & \checked \\}
\def\plainTabularTextUnchecked#1{\stepcounter{ChecklistNumber}\begin{tabular}{p{1cm}}\scriptsize \theChecklistNumber \\\end{tabular} & \scriptsize#1 & \unchecked\\}
\def\tabularitemizeFirstLayerWOCheckbox#1{ & \begin{tabular}{p{0,3cm}p{13,05cm}}\scriptsize\textbullet & \scriptsize#1 \\\end{tabular} & \\}
\def\tabularitemizeFirstLayerCheck#1{\stepcounter{ChecklistNumber}\begin{tabular}{p{1cm}}\scriptsize \theChecklistNumber \\\end{tabular} & \begin{tabular}{p{0,3cm}p{12.6cm}}\scriptsize\textbullet & \scriptsize#1 \\\end{tabular} & \checked\\}
\def\tabularitemizeFirstLayerUncheck#1{\stepcounter{ChecklistNumber}\begin{tabular}{p{1cm}}\scriptsize \theChecklistNumber \\\end{tabular} & \begin{tabular}{p{0,3cm}p{12.6cm}}\scriptsize\textbullet & \scriptsize#1 \\\end{tabular} & \unchecked\\}
\def\tabularitemizeSecondLayerCheck#1{\stepcounter{ChecklistNumber}\begin{tabular}{p{1cm}}\scriptsize \theChecklistNumber \\\end{tabular} & \begin{tabular}{p{0,3cm}p{0,3cm}p{11,9cm}}&\scriptsize - & \scriptsize#1 \\\end{tabular} & \checked\\}
\def\tabularitemizeSecondLayerUncheck#1{\stepcounter{ChecklistNumber}\begin{tabular}{p{1cm}}\scriptsize \theChecklistNumber \\\end{tabular} & \begin{tabular}{p{0,3cm}p{0,3cm}p{11,9cm}}&\scriptsize - & \scriptsize#1 \\\end{tabular} & \unchecked\\}
\def\CheckListTabBottom{\end{longtable}\end{center}}
...
\tabularitemizeSecondLayerUncheck{Meldung innerhalb 15 Tage nach Kenntnis des Vorkommnisses, wenn Kausalzusammenhang zwischen Produkt und Vorkommnis festgestellt wurde oder möglich ist}
...
\tabularitemizeFirstLayerCheck{Angeforderte Unterlagen müssen bei entsprechenden Anfragen an die Behörden ausgehändigt werden}
...
\tabularitemizeSecondLayerUncheck{Behörde kann vom Hersteller Schritte gemäß schwerwiegendem Vorkommnis einfordern, auch wenn dieser ermittelt hat, dass Vorfall nicht schwerwiegend ist oder es als erwartete, unerwünschte Nebenwirkung, die in der Meldung von Trends enthalten sein wird, klassifiziert}
\hline
...
\tabularitemizeSecondLayerUncheck{Ergebnisse und Schlussfolgerungen der PMS sowie Beschreibung und Begründung ergriffener Präventiv- und Korrekturmaßnahmen müssen enthalten sein (erstellt pro Produkt, gegebenenfalls Produktkategorie oder Produktgruppe)}
\tabularitemizeSecondLayerUncheck{Aktualisierung des Berichtes über gesamte Lebensdauer}
...
\tabularitemizeFirstLayerWOCheckbox{Aktualisierungsintervalle des Berichtes:}
...
\tabularitemizeFirstLayerUncheck{Meldung von statistisch signifikanten (entscheidend ist Vergleich mit erwartetem und in technische Dokumentation angegebener Häufung) Anstiegen der Häufigkeit oder des Schweregrades nicht schwerwiegender Vorkommnisse oder erwarteter unerwünschter Nebenwirkungen über elektronisches System, wenn Nutzen-Risiko-Analyse erheblich beeinflusst wird und Risiken für die Gesundheit entstehen}
...
\tabularitemizeFirstLayerUncheck{Durchführung von Studien über klinische Nachbeobachtung nach dem Inverkehrbringen, die von benannter Stelle gefordert werden}
\hline
...
\tabularitemizeFirstLayerUncheck{Produktstichproben oder Zugang zu Produkten bei gerechtfertigtem Anliegen den Behörden kostenfrei zur Verfügung stellen}
\tabularitemizeFirstLayerUncheck{Hersteller ergreift erforderliche Korrekturmaßnahmen, wenn Behörden aus der Analyse der Vigilanz-Daten Risiken oder nachteilige Änderungen der Nutzen-Risiko-Abwägung ermitteln und dem Hersteller mitteilen}
