...
(PMCF):}
\tabularitemizeFirstLayerUncheck{Ist Teil des Qualitätsmanagementsystems und wird aufgestellt, angewendet, aufrechterhalten und auf dem neuesten Stand gehalten}
...
\checkListTabHead
\tabularitemizeFirstLayerUncheck{Klinische Daten, die bei zweckgemäßer Verwendung erhoben werden, werden proaktiv gesammelt und ausgewertet, um:}
\tabularitemizeSecondLayerUncheck{Sicherheit und Leistung während der Lebensdauer zu bestätigen}
\tabularitemizeSecondLayerUncheck{Konformität der ermittelten Risiken sicherzustellen}
\tabularitemizeSecondLayerUncheck{Neu entstehende Risiken und Nebenwirkungen auf Grundlage empirischer Belege zu identifizieren}
\tabularitemizeSecondLayerUncheck{Vertretbarkeit Nutzen-Risiko-Verhältnis zu gewährleisten}
\tabularitemizeSecondLayerUncheck{Systematisch fehlerhafte oder zulassungsüberschreitende Verwendung festzustellen (Prüfung auf Angemessenheit der Zweckbestimmung)}
...
\tabularitemizeFirstLayerUncheck{Ergebnisse werden in Bewertungsbericht, der Teil der technischen Dokumentation ist, dokumentiert}
